...
\SetDate[27/08/2018]
\week{Week 01} Introduction to production ML systems
\week{Week 02} Case study 1 (Uber 1)
\week{Week 03} Distributed ML
\week{Week 04} Interoperability between ML engines/models
\week{Week 05} Case study 2 (Spotify)
\week{Week 06} Technical debt in ML
\week{Week 07} Systems/Performance issues in ML
\week{Week 08} Case study 3 (Netflix)
\week{Week 09} Scalability
\week{Week 10} Automatic differentiation
\week{Week 11} Data architecture patterns
\week{Week 12} Project demo
\week{Week 13} Model serving
\week{Week 14} Case study 4 (Uber 2)
